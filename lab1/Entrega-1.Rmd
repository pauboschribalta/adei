...
Com que només hem detectat un error, que pdays sigui 999 i previous sigui "yes", sabem que tenim 193 combinacions de valors que compleixen l'error.
Per tant, tindrem que 193 individus tenen 2 errors (1 a pdays i 1 a previous) i la resta (4807) no tenen cap error.
