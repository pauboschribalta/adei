...
res.immca<-imputeMCA(df$education, ncp = 18)
...
summary(df$housing)
res.immca<-imputeMCA(df$housing, ncp = 18)
summary(res.immca$completeObs)

df$housing<-res.immca$completeObs
```
...
summary(df$loan)
res.immca<-imputeMCA(df$loan, ncp = 18)
summary(res.immca$completeObs)

df$loan<-res.immca$completeObs
```
