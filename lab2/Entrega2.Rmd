...
```{r}
var_dis <- c("age", "job", "marital", "education", "default", "housing", "loan", "contact", "month", "day_of_week", "previous", "poutcome", "y")
var_con<- c("age_num", "duration", "campaign", "emp.var.rate", "cons.conf.idx", "cons.price.idx", "euribor3m", "nr.employed")
var_res<- c("y")
```
...
```{r}
res.mca<-MCA(df[,c(var_dis,"y","duration") ],quali.sup=8,quanti.sup=9)
```
