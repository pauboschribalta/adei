...
requiredPackages <- c("chemometrics","FactoMineR","car","knitr","missMDA","ResourceSelection", "pROC", "MASS")
...
influential_values <- as.data.frame(influential_points[, -ncol(influential_points)])
...
for (i in 1:4) {
  plot(influential_points[, i], influential_points$y,
       xlab = names(influential_points)[i], ylab = "y", main = "Influential Points",
       pch = 19, col = "blue")
}
